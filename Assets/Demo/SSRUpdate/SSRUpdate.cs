...
{
    enum Pass { depth, reflection, blur, accumulation, composition }
    ...
    void OnRenderImage(RenderTexture src, RenderTexture dst)
    {
        ...
        if (blurNum > 0)
        {
            ...
            mat.SetVector("_BlurParams", new Vector4(blurOffset.x, 0f, blurNum, 0));
            mat.SetPass((int)Pass.blur);
            ...
            mat.SetVector("_BlurParams", new Vector4(0f, blurOffset.y, blurNum, 0));
            mat.SetPass((int)Pass.blur);
            Graphics.DrawMeshNow(quad, Matrix4x4.identity);
